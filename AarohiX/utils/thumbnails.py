...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("AarohiX/assets/defaultfont.ttf", 30)
    font = ImageFont.truetype("AarohiX/assets/defaultfont.ttf", 30)
    title_font = ImageFont.truetype("AarohiX/assets/defaultfont.ttf", 45)
