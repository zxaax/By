...
async def sourc(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/12bccdecea07b69e966c1.jpg",
        caption=f"""✧ 𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝑻𝒐 𝑺𝒐𝒖𝒓𝒄𝒆 𝒇𝒂𝒉𝒆𝒅 \n\n• ᴅᴇᴠᴇʟᴏᴘᴇʀ -› @PPF22\n• ᴄʜᴀɴɴᴇʟ ғᴀʜᴇᴅ -› @Tepthon\n\n**- للتنصيب أو للاستفسار تواصل مع مطور السورس**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                       "مطور السورس", user_id=1260465030)
                ],[
                    InlineKeyboardButton(
                       "♡🇵🇸", url=f"https://t.me/Tepthon")
