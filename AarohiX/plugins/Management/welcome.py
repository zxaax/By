...
from AarohiX.utils.daxx_ban import admin_filter
...
from AarohiX.mongo.afkdb import PROCESS
from pyrogram import Client, filters
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    font = ImageFont.truetype('AarohiX/assets/font.ttf', size=70)
    welcome_font = ImageFont.truetype('AarohiX/assets/font.ttf', size=61)
